...
/**
 *
 * Based on https://github.com/Team766/2015/blob/5d027b62ec1535861083adb06a34e343caa21e7b/src/org/usfirst/frc/team766/robot/commands/Drive/DriveTurn.java
 *
 */
public class PIDTurn766 extends Command {
	...
	private PIDController pid = new PIDController(0.35, 0.01, 0.15, -0.5, 0.5, .5); // creates PID controller with -0.5, 0.5, and .5 as min/max/tolerance
